...
export const collaborations = [
    ...
    { name: "Paragon Tweaks", imgSrc: "/paragon.jpg"},
    { name: "EXM Tweaks", imgSrc: "/exm.jpg"},
    { name: "Easley Combined Utilities", imgSrc: "/easley.jpg"},
];
